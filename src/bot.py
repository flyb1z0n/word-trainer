...
async def on_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    response = llm_service.get_text_card(update.message.text)
    await context.bot.send_message(chat_id=update.effective_chat.id, text=response.to_message(), parse_mode='Markdown')
